...
class BinanceServiceTest extends TestCase
{
    ...
    // ./vendor/bin/phpunit --filter testGetTradeList tests/Unit/BinanceServiceTest.php
    public function testGetTradeList()
    {
        $price = BinanceService::getTradeList("COMPUSDT");
